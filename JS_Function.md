...
### <span style='background-color: #FBE7A1'반환(return)</span>  
...
### <span style='background-color: #FBE7A1'기명 함수</span>  
...
### <span style='background-color: #FBE7A1'익명 함수</span>  
이름이 없는 함수는 '익명 함수'라고 한다.  
이러한 익명 함수들은 <u>데이터로써 활용</u>되거나 <u>변수(예시 name과같은)에 할당</u>되어서 활용되기도 한다.  
```
// 함수를 표현하는 것
...
### <span style='background-color: #FBE7A1'객체 데이터</span>  
'name', 'age'와 같은 <u>**속성**에 **함수 데이터가 들어가 있는 것**</u>을 **메소드(Method)** 라고 한다.  
